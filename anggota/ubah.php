                            ...
                            <div class="content">
                              <form action="" method="post">
                                ...
                                <div class="kotak1">
                                    ...
                                    <div class="input">
                                    <input type="text" style="width:500px;" name="npm" value="<?= $row['npm']?>" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                    ...
                                    <div class="input">
                                    <input type="text" style="width:500px;" name="nama_anggota" value="<?= $row['nama_anggota']?>" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                ...
                                <div class="input">
                                    <input type="text" style="width:500px;" name="alamat" value="<?= $row['alamat']?>" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                    ...
                                    <div class="input">
                                    <input type="number" style="width:500px;" name="nohp" value="<?= $row['nohp']?>" required>
                                    </div>
                                </div>
