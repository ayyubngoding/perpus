                            ...
                            <div class="content">
                              <form action="" method="post">
                                <div class="kotak1">
                                    ...
                                    <div class="input">
                                    <input type="text" style="width:500px;" name="npm" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                    ...
                                    <div class="input">
                                    <input type="text" style="width:500px;" name="nama_anggota" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                ...
                                <div class="input">
                                    <input type="text" style="width:500px;" name="alamat" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                    ...
                                    <div class="input">
                                    <input type="number" style="width:500px;" name="nohp" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                    ...
                                    <div class="input">
                                    <input type="text" style="width:500px;" name="keterangan" value="Tidak Meminjam" readonly>
                                    </div>
                                </div>
