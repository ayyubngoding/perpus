                            ...
                            <div class="content">
                              <form action="" method="post">
                                <div class="kotak1">
                                    ...
                                    <div class="input">
                                    <input type="text" style="width:500px;" name="namabuku" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                    ...
                                    <div class="input">
                                    <input type="text" style="width:500px;" name="pengarang" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                ...
                                <div class="input">
                                    <input type="text" style="width:500px;" name="penerbit" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                    ...
                                    <div class="input">
                                    <input type="date" style="width:500px;" name="tahunterbit" required>
                                    </div>
                                </div>
                                <div class="kotak1">
                                    <div class="label">
                                    ...
                                    <div class="input">
                                    <input type="text" style="width:500px;" name="stok" required>
                                    </div>
                                </div>
                                <div class="pull-right">
                            <button type="submit" class="btn btn-primary btn-md" name="submit">Submit</button>
                            <a href="buku.php" class="btn btn-danger btn-md">Kembali</a>
                        </div>     
                        </form>
